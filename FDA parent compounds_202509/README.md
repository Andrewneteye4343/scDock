...
Set the argument use_fda to true and specify fda_txt_path in config.yaml$vina_docking.
Place the provided fda.txt file in the directory specified by fda_txt_path.
