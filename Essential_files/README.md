...
4. Place ligand_reference.csv and receptor_reference.csv in your computer (set argument Vina_Docking_ligand_ref_file and Vina_Docking_receptor_ref_file). In this example, we use: /home/path/to/scDock/functions/ligand_reference.csv and /home/path/to/scDock/functions/receptor_reference.
Note: These reference files are updated for changing download soruce from SWISS-MODEL to Protein Data Bank (PDB) on 2026/02/08.  
