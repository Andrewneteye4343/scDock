...
The "sample_group" label can be used as the value for the argument `Run_CellChat_group_by argument` or `Run_Integration_group_by` in config.yaml for downstream CellChat analysis.  
