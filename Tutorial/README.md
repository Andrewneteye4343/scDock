...
10. `Vina_Docking_cas_txt_file` This argument specifies the location of cas.txt. You may provide a text file containing the CAS numbers of the compounds you are interested in, with one number per line. If this file is provided, the program will ignore both use_fda and fda_txt_path.  
