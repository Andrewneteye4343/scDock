...
● Data preparation:  
Please manually download those data to your computer. We recommand users to modify the file names as the below example for 10X Cell Ranger data. For example, you should get the below data in each directory (sample):  
`barcodes.tsv.gz`  
`features.tsv.gz`  
`matrix.mtx.gz`  
